...
- **CSS3:** Custom styles for input states, button hovers, and responsive transitions.

## 📁 File Structure
```text
├── prac.html                    # Main HTML containing the form structure and inline styling
...
1. Clone the repo
   ```sh
   git clone https://github.com/paarshviv12/ONLINE-FORM.git
   ```
